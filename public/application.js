...
var showGamesPlayed = function showGamesPlayed() {
  event.preventDefault();
  api.getGames().then(ui.showGamesSuccess).catch(ui.showGamesFailure);
};
...
var store = __webpack_require__(1);
var gameLogic = __webpack_require__(14);
...
var runGame = function runGame() {
  ...
  var placeMove = function placeMove() {
    $('.spaces').on('click', function (event) {
      ...
      // check for winner
      if (gameBoard[0] === 'X' && gameBoard[1] === 'X' && gameBoard[2] === 'X' || gameBoard[0] === 'X' && gameBoard[3] === 'X' && gameBoard[6] === 'X' || gameBoard[0] === 'X' && gameBoard[4] === 'X' && gameBoard[8] === 'X' || gameBoard[2] === 'X' && gameBoard[5] === 'X' && gameBoard[8] === 'X' || gameBoard[6] === 'X' && gameBoard[7] === 'X' && gameBoard[8] === 'X' || gameBoard[3] === 'X' && gameBoard[4] === 'X' && gameBoard[5] === 'X' || gameBoard[1] === 'X' && gameBoard[4] === 'X' && gameBoard[7] === 'X' || gameBoard[2] === 'X' && gameBoard[4] === 'X' && gameBoard[6] === 'X') {
        // gameOver = true
        ...
        $('#new-game').removeClass('hidden');
        // console.log(store.gameState)
      } else if (gameBoard[0] === 'O' && gameBoard[1] === 'O' && gameBoard[2] === 'O' || gameBoard[0] === 'O' && gameBoard[3] === 'O' && gameBoard[6] === 'O' || gameBoard[0] === 'O' && gameBoard[4] === 'O' && gameBoard[8] === 'O' || gameBoard[2] === 'O' && gameBoard[5] === 'O' && gameBoard[8] === 'O' || gameBoard[6] === 'O' && gameBoard[7] === 'O' && gameBoard[8] === 'O' || gameBoard[3] === 'O' && gameBoard[4] === 'O' && gameBoard[5] === 'O' || gameBoard[1] === 'O' && gameBoard[4] === 'O' && gameBoard[7] === 'O' || gameBoard[2] === 'O' && gameBoard[4] === 'O' && gameBoard[6] === 'O') {
